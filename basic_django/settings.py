...
MEDIA_ROOT = '/Projects/HDWebsoft/workspace/Python/python_django/basic_django/media/'
...
EMAIL_USE_TLS       = True
# # MAIL_USE_SSL    = False
# MAIL_SUBJECT_PREFIX = '[basic_django]'
...
try:
    from basic_django.local_settings import *
except ImportError:
    pass